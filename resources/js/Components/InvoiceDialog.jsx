                                                ...
                                                <tbody>
                                                    <tr className="border-b border-gray-100">
                                                        <td className="px-4 py-4">
                                                            <div className="font-semibold text-gray-900">{book?.title || "Unknown Book"}</div>
                                                            {book?.author && (
                                                                <div className="mt-1 text-sm text-gray-500">by {book.author}</div>
                                                            )}
                                                        </td>
                                                        <td className="px-4 py-4 text-center text-gray-700">{order.quantity}</td>
                                                        <td className="px-4 py-4 text-right text-gray-700">
                                                            {formatPrice((order.total_amount - order.shipping_cost) / order.quantity)}
                                                        </td>
                                                    ...
                                                    <tr className="border-b border-gray-100">
                                                        ...
                                                        <td className="px-4 py-4 text-right text-gray-700">{formatPrice(order.shipping_cost)}</td>
                                                    </tr>
                                                    <tr className="bg-primary-50">
                                                        <td colSpan={3} className="px-4 py-4 text-lg font-bold text-gray-900">
                                                            Total Amount
                                                        </td>
