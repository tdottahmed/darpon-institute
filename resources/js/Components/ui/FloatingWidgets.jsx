        ...
        <div className="fixed bottom-6 right-6 z-[100] flex flex-col items-end gap-3">
            ...
            {whatsappHref && (
                <a
                    ...
                    title="WhatsApp"
                    className="relative flex items-center justify-center w-14 h-14 bg-[#25D366] hover:bg-[#1ebe5d] text-white rounded-full shadow-xl transition-all duration-300 hover:scale-105"
                >
