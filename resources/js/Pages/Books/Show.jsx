                    ...
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="lg:grid lg:grid-cols-2 lg:gap-x-12 xl:gap-x-16">
                            ...
                            <div className="product-image-wrapper">
                                {book.preview_images &&
                                book.preview_images.length > 0 ? (
                                    <BookPreviewGallery
                                        previewImages={book.preview_images}
                            ...
                            <div className="mt-10 px-4 sm:mt-16 sm:px-0 lg:mt-0">
                                ...
                                <div className="mt-10 flex gap-4">
                                    ...
                                    {book.stock_quantity > 0 ? (
                                        ...
                                        <button
                                            disabled
                                            className="flex w-full items-center justify-center rounded-xl bg-gray-300 px-8 py-4 text-base font-bold text-gray-500 cursor-not-allowed dark:bg-gray-800 dark:text-gray-600"
                                        >
                                            Out of Stock
                                        </button>
                                    )}
