...
import {
    Download, CheckCircle2, ArrowRight, Home,
    CreditCard, User, Mail, Phone, MapPin, Truck, Loader2,
} from "lucide-react";
...
export default function Checkout({ book, order = null, isNewUser = false }) {
    ...
    const submit = (e) => {
        ...
        post(route("books.checkout.store", book.slug), { preserveScroll: true });
    };
                        ...
                        <Container>
                            <div className="max-w-2xl mx-auto">
                                ...
                                <div className="mb-4 flex items-center justify-center gap-2.5 rounded-2xl bg-green-500 px-5 py-3 text-sm font-semibold text-white shadow-sm">
                                    ...
                                    Order placed! We'll contact you to arrange delivery.
                                </div>
                                ...
                                <div ref={invoiceContentRef} className="invoice-content bg-white dark:bg-gray-800">
                                    ...
                                    <div className="relative bg-gradient-to-br from-primary-600 via-primary-700 to-secondary-600 overflow-hidden">
                                        ...
                                        <div className="relative px-5 pt-6 pb-5 sm:px-8 sm:pt-7 sm:pb-6">
                                            <div className="flex items-start justify-between gap-4 mb-5">
                                                <div>
                                                    <p className="text-xs font-semibold uppercase tracking-widest text-white/60 mb-1">Book Order</p>
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                <span className="inline-flex items-center rounded-full bg-white/15 backdrop-blur-sm px-3 py-1 text-xs font-mono font-bold text-white">
                                                    {invoiceNumber}
                                                </span>
                                    ...
                                    <div className="px-5 py-6 sm:px-8 sm:py-7 space-y-6">
                                        ...
                                        {/* Customer info */}
                                        <section>
                                            <h2 className="mb-3 text-[11px] font-bold uppercase tracking-widest text-gray-400 dark:text-gray-500">Customer Information</h2>
                                            <div className="grid grid-cols-2 gap-3">
                                                {[
                                                    { icon: <User className="h-3.5 w-3.5" />, label: "Full Name", value: order.name },
                                                    { icon: <Mail className="h-3.5 w-3.5" />, label: "Email", value: order.email, truncate: true },
                                                    { icon: <Phone className="h-3.5 w-3.5" />, label: "Phone", value: order.phone },
                                                    { icon: <Truck className="h-3.5 w-3.5" />, label: "Shipping", value: order.shipping_method === "inside_dhaka" ? "Inside Dhaka" : "Outside Dhaka" },
                                                    ...
                                                    <div key={label} className="rounded-xl bg-gray-50 dark:bg-gray-700/50 px-3.5 py-3">
                                                        ...
                                                        <p className={`text-sm font-semibold text-gray-900 dark:text-white ${truncate ? "truncate" : ""}`}>
                                                            {value}
                                                        </p>
                                                    </div>
                                                ))}
                                                <div className="col-span-2 rounded-xl bg-gray-50 dark:bg-gray-700/50 px-3.5 py-3">
                                                    ...
                                                    <p className="text-sm font-semibold text-gray-900 dark:text-white whitespace-pre-wrap">{order.address}</p>
                                                </div>
                                            </div>
                                        </section>
                                        ...
                                        {/* Order details */}
                                        <section>
                                            <h2 className="mb-3 text-[11px] font-bold uppercase tracking-widest text-gray-400 dark:text-gray-500">Order Details</h2>
                                            <div className="rounded-xl overflow-hidden border border-gray-100 dark:border-gray-700">
                                                ...
                                                <div className="px-4 py-4 bg-gray-50 dark:bg-gray-700/40">
                                                    <div className="flex items-start justify-between gap-3">
                                                        <div className="min-w-0">
                                                            <p className="font-bold text-gray-900 dark:text-white leading-snug">{book?.title || "Unknown Book"}</p>
                                                            {book?.author && (
                                                                <p className="mt-0.5 text-xs text-gray-500 dark:text-gray-400">by {book.author}</p>
                                                            )}
                                                ...
                                                <div className="flex items-center justify-between px-4 py-3 border-t border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-800">
                                                    ...
                                                    <span className="text-sm font-semibold text-gray-700 dark:text-gray-300">{formatPrice(order.shipping_cost)}</span>
                                                </div>
                                                {/* Total row */}
                                                <div className="flex items-center justify-between px-4 py-3 bg-primary-600 dark:bg-primary-700">
                                                    ...
                                                    <span className="text-xl font-black text-white">{formatPrice(order.total_amount)}</span>
                                                </div>
                                            </div>
                                        </section>
                                            ...
                                            <div className="flex items-center gap-3 rounded-xl bg-primary-50 dark:bg-primary-900/20 border border-primary-100 dark:border-primary-800 px-4 py-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                                                        Pay {formatPrice(order.total_amount)} when you receive your order.
                                                    </p>
                                                </div>
                                            </div>
                                        </section>
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="grid gap-6 sm:grid-cols-2">
                                            <div>
                                                ...
                                                <TextInput
                                                    ...
                                                    value={data.name}
                                                    onChange={(e) => !user && setData("name", e.target.value)}
                                                    readOnly={!!user}
                                                    required
                                            ...
                                            <div>
                                                ...
                                                {(errors.phone || phoneError) ? (
                                                    ...
                                                    <p className="mt-1.5 text-xs text-gray-400 dark:text-gray-500">11-digit Bangladeshi number</p>
                                                )}
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <TextInput
                                                ...
                                                className={`mt-1 block w-full ${user ? "bg-gray-50 dark:bg-gray-800 cursor-not-allowed opacity-75" : ""}`}
                                                value={data.email}
                                                onChange={(e) => !user && setData("email", e.target.value)}
                                                readOnly={!!user}
                                                required
                                        ...
                                        <div>
                                            ...
                                            <div className="grid gap-4 sm:grid-cols-2">
                                                {[
                                                    { value: "inside_dhaka", label: "Inside Dhaka", time: "2–3 Days Delivery", price: 60 },
                                                    { value: "outside_dhaka", label: "Outside Dhaka", time: "3–5 Days Delivery", price: 120 },
                                                ].map((opt) => (
                                                    <label
                                                        key={opt.value}
                                                        className={`relative flex cursor-pointer rounded-xl border p-4 shadow-sm transition-all ${
                                                            data.shipping_method === opt.value
                                                    ...
                                                    >
                                                        <input
                                                            ...
                                                            value={opt.value}
                                                            className="sr-only"
                                                            checked={data.shipping_method === opt.value}
                                                        ...
                                                        <span className="flex flex-1 flex-col">
                                                            ...
                                                            <span className="mt-0.5 text-xs text-gray-500 dark:text-gray-400">{opt.time}</span>
                                                        </span>
                                    ...
                                    <Card variant="elevated" className="p-6">
                                        ...
                                        <div className="flex gap-4 mb-4 pb-4 border-b border-gray-100 dark:border-gray-700">
                                            <div className="h-16 w-12 shrink-0 overflow-hidden rounded-md border border-gray-200 dark:border-gray-700">
                                                {book.cover_image ? (
                                                    ...
                                                    <div className="flex h-full w-full items-center justify-center bg-gray-100 dark:bg-gray-700 text-xs text-gray-400">No img</div>
                                                )}
                                            </div>
                                            <div className="flex flex-1 flex-col min-w-0">
                                                ...
                                                <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">Qty {data.quantity}</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="mt-5 rounded-xl bg-gray-50 dark:bg-gray-800 p-4 flex items-start gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="mt-0.5 text-xs text-gray-500 dark:text-gray-400">Pay when you receive your order.</p>
                                            </div>
                                        </div>
