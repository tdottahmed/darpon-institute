              ...
              @forelse($orders as $order)
                <tr>
                  ...
                  <td class="whitespace-nowrap px-3 py-4 text-sm">
                    ...
                    @endphp
                    <span class="{{ $statusClass }} inline-flex rounded-full px-2 text-xs font-semibold leading-5">
                  ...
                  <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                    <a href="{{ route('admin.book-orders.show', $order) }}"
                       class="mr-4 text-primary-600 hover:text-primary-900 dark:text-primary-400 dark:hover:text-primary-300">View</a>
                  </td>
                </tr>
              @empty
                <tr>
