    ...
    <form action="{{ $formAction }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="space-y-6">
        ...
        <div class="flex items-center justify-end gap-4 border-t border-gray-200 pt-6">
          <a href="{{ isset($landingPage) ? route('admin.landing-pages.edit', $landingPage) : route('admin.landing-pages.create') }}?tab=hero"
          ...
          <x-button type="submit" variant="primary" size="md">
            ...
            {{ isset($landingPage) ? 'Update Hero Section' : 'Save Hero Section' }}
          </x-button>
        </div>
      </div>
    </form>
