  ...
  <div class="space-y-6">
    ...
    <x-card variant="elevated">
      <form action="{{ route('admin.courses.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="space-y-6">
          <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
            <x-forms.input name="price" label="Price (BDT)" type="number" step="0.01" min="0"
                           :value="old('price')" placeholder="0.00" :error="$errors->first('price')" />
          </div>
          ...
          <div
            ...
            <div>
              <x-forms.input name="discount" label="Discount Value" type="number" step="0.01" min="0"
                             :value="old('discount', 0)" placeholder="0" :error="$errors->first('discount')" id="discount-input" />
          ...
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div class="flex items-center space-x-3">
              ...
              <input type="checkbox" name="online_enrollment_enabled" id="online_enrollment_enabled" value="1"
                     {{ old('online_enrollment_enabled', 1) ? 'checked' : '' }}
            ...
            <div class="flex items-center space-x-3">
              ...
              <input type="checkbox" name="offline_enrollment_enabled" id="offline_enrollment_enabled" value="1"
                     {{ old('offline_enrollment_enabled', 0) ? 'checked' : '' }}
                     class="h-4 w-4 rounded border-gray-300 text-primary-600 focus:ring-primary-500">
        ...
        <!-- Files - Full Width -->
        <div class="space-y-6">
          <x-forms.image-uploader name="thumbnail" label="Thumbnail" :value="old('thumbnail')" accept="image/*"
