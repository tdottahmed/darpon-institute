      ...
      <x-card variant="elevated" class="max-w-8xl">
        <div class="space-y-6">
          ...
          <div class="space-y-4 rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800/50">
            ...
            <x-forms.input label="SEO title" type="text" id="meta_title" name="meta_title" value="{{ old('meta_title') }}"
                           placeholder="Shown in search results and browser tab" :error="$errors->first('meta_title')"
