...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #000; margin: 0; padding: 0;">
  <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
    <!-- Header -->
    <div
         style="border-bottom: 2px solid #000; padding: 20px 0; margin-bottom: 20px; display: flex; align-items: center; gap: 12px;">
      @php
        $logoPath = \App\Models\Setting::get('logo_light');
        $logoUrl = $logoPath ? asset('storage/' . $logoPath) : asset('darponbdv.png');
      @endphp
      <div>
        <img src="{{ $logoUrl }}" alt="{{ config('app.name', 'Darpon') }}"
