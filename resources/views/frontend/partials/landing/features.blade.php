@php
    ...
    $featuresTitle = $landingPage->features_list_title ?? '';
    $featuresDescription = $landingPage->features_list_description ?? '';
    $targetAudienceTitle = $landingPage->target_audience_list_title ?? '';
    ...
    $gameChangerTitle = $landingPage->game_changer_title ?? '';
    $gameChangerDescription = $landingPage->game_changer_description ?? '';
    $gameChangerConclusion = $landingPage->game_changer_conclusion ?? '';
@endphp

<section class="features-section section-sm" style="background-color: #073050;">
    <div class="container-narrow">
        <div class="features-grid" style="display: grid; grid-template-columns: 1fr">
            ...
            @php
                // Check if target audience description has actual content (not just empty HTML tags)
