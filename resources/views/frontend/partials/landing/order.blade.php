      ...
      <div style="border-top: 2px solid #eee; padding-top: 30px;">
        ...
        <div
          ...
          <div style="flex-grow: 1;">
            <div style="font-weight: 600; color: #333; font-size: 0.95rem; margin-bottom: 8px;">{{ $productTitle }}
            </div>
            <div style="display: flex; align-items: center; gap: 15px; margin-top: 8px; flex-wrap: wrap;">
              <!-- Qty Selector (Only for Books) -->
              @if ($productType === 'book')
                <div style="display: flex; align-items: center; gap: 8px;">
                  <label style="font-size: 0.85rem; color: #666; font-weight: 500;">Quantity:</label>
                  <div
        ...
        @else
          ...
          <div style="margin-bottom: 15px;">
            <label style="display: block; font-weight: 600; margin-bottom: 5px; color: #333;">Transaction ID <span
                    style="color: red;">*</span></label>
          ...
          <!-- Payment Screenshot -->
          <div style="margin-bottom: 15px;">
            <label style="display: block; font-weight: 600; margin-bottom: 5px; color: #333;">Payment Screenshot
              (Optional)</label>
