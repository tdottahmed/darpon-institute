<div 
    ...
    x-init="
        Livewire.on('toast', (event) => {
            toasts.push({ id: Date.now(), type: event.type, message: event.message });
            setTimeout(() => {
                const index = toasts.findIndex(t => t.id === event.id || t.message === event.message);
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-4 flex flex-shrink-0">
                            <button 
                                ...
                                :class="{
                                    'bg-green-50 text-green-800 hover:opacity-75 focus:ring-green-500': toast.type === 'success',
                                    'bg-red-50 text-red-800 hover:opacity-75 focus:ring-red-500': toast.type === 'error',
                                    'bg-yellow-50 text-yellow-800 hover:opacity-75 focus:ring-yellow-500': toast.type === 'warning',
                                    'bg-blue-50 text-blue-800 hover:opacity-75 focus:ring-blue-500': toast.type === 'info'
                                }"
                            >
